...
export default function JournalsPage() {
  return (
    <main className="min-h-screen bg-[#FCFAF6]">
      ...
      <section className="border-t border-black/10 bg-[#f5f0e8] px-6 py-12 text-center"><p className="text-[9px] tracking-[.22em] text-black/55">FROM THE BREWERY</p><h2 className="mx-auto mt-3 max-w-xl font-serif text-3xl leading-[.9] tracking-[-.02em]">More stories, same clear idea.</h2><p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-black/60">How we brew light without losing flavour — and what we’re pouring next.</p><Link href="/shop" className="mt-6 inline-block border border-black bg-white px-6 py-3 text-[10px] tracking-[.14em] transition-colors hover:bg-black hover:text-white">SHOP THE RANGE</Link></section>
    </main>
  );
}
