...
export const products: StoreProduct[] = [
  ...
  { id: "blood-orange", name: "Blood Orange Lager", price: 18, src: "/images/blu-blood.png", note: "Blood orange · 102 kcal", shade: "#ff9a62", flavour: "Bold & bittersweet", description: "Sunset in a can. Bittersweet blood orange over a cold-fermented light lager — bright citrus first, soft bitter at the close.", tasting: ["Blood orange", "Citrus zest", "Light hops", "Bittersweet finish"], content: "Water, barley malt, hops, natural blood orange flavour. Vegan. Gluten-free. Cold-fermented.", abv: "4.2% ABV", kcal: "102 kcal / 330ml" },
